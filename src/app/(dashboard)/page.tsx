                  ...
                  upcomingBirthdays.map((client: any) => (
                    <div key={client.id} className="flex items-center justify-between p-4 bg-background border border-border/40 rounded-2xl hover:border-primary/30 transition-colors">
                      ...
                      <div className="text-right flex items-center gap-3">
                        ...
                        {client.whatsapp && (
                          <a 
                            href={`https://wa.me/${client.whatsapp.replace(/\\D/g, '')}?text=${encodeURIComponent(`¡Hola ${client.name.split(' ')[0]}! ${String.fromCodePoint(0x1F389, 0x1F382)} De parte de todo el equipo de Chicle Repostería queremos desearte un muy ¡Feliz Cumpleaños! Que tengas un día increíble lleno de dulzura.`)}`} 
                            target="_blank" 
