...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[100dvh] bg-background">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 lg:sticky lg:top-0 lg:translate-x-0 shadow-2xl lg:shadow-none ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
